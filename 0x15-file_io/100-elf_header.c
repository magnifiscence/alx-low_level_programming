...
/**
 * print_magic - function Prints  numbers of an ELF header.
 * @e_ident: represents pointer to  array containing the ELF magic numbers.
 *
...
/**
 * print_class -  function thatPrints the class of an ELF header.
 * @e_ident: A pointer
 */
void print_class(unsigned char *e_ident)
{
...
/**
 * print_abi - function thatPrints the ABI version of an ELF header.
 * @e_ident: A pointer.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_entry: represents address of the ELF entry point.
 * @e_ident: A pointer.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @elf: represents file descriptor of the ELF file.
 *
 ...
 * @argv: represents array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
