...
/**
 * check_elf - function verifies if file is an ELF file
 * @e_ident: pointer
...
/**
 * print_magic - function prints magic numbers of an ELF header
 ...
 * @e_ident: Pointer to an array cointaining ELF
 */
void print_osabi(unsigned char *e_ident)
{
	printf("OS/ABI:");
...
/**
 * print_type - function prints type of an ELF header
 * @e_type: type
 * @e_ident: pointer
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * main - displays information in ELF header
 * @argc: number of arguments
 * @argv: array of pointers to arguments
 * Return: 0 on success
 * exit code 98 if it fails or is not an ELF file
 */
